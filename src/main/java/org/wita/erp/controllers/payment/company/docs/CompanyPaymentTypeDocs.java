...
public interface CompanyPaymentTypeDocs {
    ...
    @Operation(summary = "List Paged Company's payment types", description = "Return a company's payment type list with pagination support. \nRequires COMPANY_PAYMENT_READ authority.")
    @ApiResponses(value = {
    ...
    ResponseEntity<CompanyPaymentTypeDTO> delete(@Parameter(description = "UUID of the company's payment type to remove", example = "123e4567-e89b-12d3-a456-426614174000")
                                                 UUID id);
